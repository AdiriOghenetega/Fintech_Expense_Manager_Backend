...
exports.duplicateReport = exports.deleteReport = exports.getReportData = exports.downloadReport = exports.generateReport = exports.createReport = exports.getReports = void 0;
...
const createReportSchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(['monthly', 'quarterly', 'yearly', 'custom']).transform((val) => {
    ...
    parameters: zod_1.z.object({
        ...
        groupBy: zod_1.z.enum(['day', 'week', 'month', 'category']).default('month'),
    }),
    isScheduled: zod_1.z.boolean().default(false),
...
exports.createReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    logger_1.default.info(`Report created: ${report.id} for user ${userId}`);
    res.status(201).json({
        success: true,
...
exports.generateReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        const reportData = await generateReportData(userId, report.parameters);
        res.json({
            success: true,
        ...
        logger_1.default.error(`Report generation failed for ${id}:`, error);
        res.status(500).json({
            success: false,
...
exports.downloadReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        switch (format) {
            case 'pdf':
                fileBuffer = await (0, reportGenerationService_1.generatePDFReport)(report, reportData);
                filename = `${report.name.replace(/[^a-z0-9]/gi, '_')}.pdf`;
                mimeType = 'application/pdf';
                break;
            case 'csv':
                fileBuffer = await (0, reportGenerationService_1.generateCSVReport)(reportData);
                filename = `${report.name.replace(/[^a-z0-9]/gi, '_')}.csv`;
                mimeType = 'text/csv';
                break;
            case 'excel':
                fileBuffer = await (0, reportGenerationService_1.generateExcelReport)(report, reportData);
        ...
        logger_1.default.error(`Report download failed for ${id}:`, error);
        res.status(500).json({
            success: false,
...
exports.getReportData = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const userId = req.user.id;
    ...
    try {
        ...
        logger_1.default.error('Report data generation failed:', error);
        res.status(500).json({
            success: false,
...
exports.deleteReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    logger_1.default.info(`Report deleted: ${id} by user ${userId}`);
    res.json({
        success: true,
        message: 'Report deleted successfully',
    });
});
exports.duplicateReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const userId = req.user.id;
    const { id } = req.params;
...
async function generateReportData(userId, parameters) {
...
function findTopSpendingDay(expenses) {
...
function calculateSpendingByDayOfWeek(expenses) {
